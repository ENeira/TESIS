<?= form_open('home/info_asignatura', array('class' => 'form_horizontal'));?>
	...
	<!--	<?= form_label('Semestre malla', 'semestre_malla', array('class'=> 'control-label')); ?>	
		...
		<div class="control-group">
	<!-- <?= form_label('Horas catedras por semestre', 'hcxsemestre', array('class'=> 'control-label')); ?>	
		<span class="uneditable-input"> <?= $registro->hcxsemestre; ?></span> -->
		<?= form_hidden('hcxsemestre', $registro->hcxsemestre); ?>                        
	</div> 
	
		<div class="control-group">
	<!-- <?= form_label('Horas ayudantias por semana', 'haxsemana', array('class'=> 'control-label')); ?>	
		<span class="uneditable-input"> <?= $registro->haxsemana; ?></span> -->
		<?= form_hidden('haxsemana', $registro->haxsemana); ?>                        
	</div> 
		<div class="control-group">
	<!-- <?= form_label('Horas laboratorio por semana', 'hlxsemana', array('class'=> 'control-label')); ?>	
		<span class="uneditable-input"> <?= $registro->hlxsemana; ?></span> -->
		<?= form_hidden('hlxsemana', $registro->hlxsemana); ?>                        
	</div>  
